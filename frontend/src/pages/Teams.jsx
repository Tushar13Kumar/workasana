      ...
      <main style={{ marginLeft: "220px", flex: 1, padding: "32px", minWidth: 0 }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(240px, 1fr))", gap: "16px" }}>
          {teams.length === 0 ? (
            ...
            >
              <h3 style={{ fontSize: "15px", fontWeight: 600, color: "#111827", margin: "0 0 4px" }}>{team.name}</h3>
              {team.description && <p style={{ fontSize: "12px", color: "#9ca3af", margin: "0 0 12px" }}>{team.description}</p>}
              <div style={{ display: "flex", gap: "6px", flexWrap: "wrap", marginTop: "12px" }}>
                ...
                {(team.members || []).length === 0 && (
                  <p style={{ fontSize: "12px", color: "#9ca3af", margin: 0 }}>No members</p>
                )}
              </div>
            </div>
          ))}
